...
execute "hi Number guifg="      . s:Colors[3]  . " guibg="" gui=none"
execute "hi Boolean guifg="     . s:Colors[11] . " guibg="" gui=none"
...
execute "hi MatchParen guifg="  . s:Colors[5] . " guibg="" gui=none"
